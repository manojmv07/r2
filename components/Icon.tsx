...
interface IconProps extends React.SVGProps<SVGSVGElement> {
    name: 'upload' | 'arrow-right' | 'summary' | 'chat' | 'critique' | 'lightbulb' | 'reset' | 'send' | 'strength' | 'weakness' | 'future' | 'novelty' | 'link' | 'export' | 'regenerate' | 'takeaways' | 'concept-map' | 'history';
    className?: string;
}
